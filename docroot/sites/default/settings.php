...
$databases = array (
  ...
  array (
    'default' => 
    array (
      'database' => 'drupal_urbanark_stage',
      'username' => 'urbanark',
      'password' => 'ua2209_aw',
      'host' => 'localhost',
      'port' => '',
 ...
 *
 */
$drupal_hash_salt = 'uvNMc7Uod9xpKvxr2t_qO2__dE_M3yINpGRW3K6SM1I';
...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/urbanark/urbanark-settings.inc');
}
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_urbanark_dev_default.inc')) {
